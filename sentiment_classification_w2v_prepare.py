...
stanfordNlp = StanfordCoreNLP("D:\code\stanford-corenlp-full\stanford-corenlp-full-2018-02-27" )
...
def process(mode, text_max_len):
    ...
    with open(in_path, 'r', encoding='utf-8') as r, open(out_path, 'w', encoding='utf-8') as w:
        for line in tqdm(r.readlines()[1:]):
            ...
            arcs = list(stanfordNlp.dependency_parse(text[:text_max_len]))#依存句法分析
